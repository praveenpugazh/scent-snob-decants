  ...
  return (
    <div>
      ...
      <section style={S.hero}>
        ...
        <h1 style={S.heroH1}>
          Scent<br />Snob <em style={S.heroEm}>Decants</em>
        </h1>
      ...
      <section style={{ ...S.section, background: C.bg1 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 8, marginTop: 16 }}>
          {[[-1, '←'], [1, '→']].map(([d, l]) => (
            <button key={d} onClick={() => scrollCar(d)} style={{
              width: 36, height: 36, border: `0.5px solid ${C.border}`,
              background: C.bg3, borderRadius: 2, cursor: 'pointer',
              color: C.t2, fontSize: 14, transition: 'all .15s',
            }}>
              {l}
            </button>
          ))}
