...
export const S = {
  ...
  navBtn: { fontSize:11, letterSpacing:'0.15em', textTransform:'uppercase', cursor:'pointer', background:'none', border:'none', fontFamily:'var(--ff-sans)', padding:0, transition:'color .15s' },
  cartBtn: { display:'flex', alignItems:'center', gap:8, cursor:'pointer', fontSize:11, letterSpacing:'0.1em', textTransform:'uppercase' },
  cartBubble: { background:'#b09060', color:'#fff', fontSize:9, width:18, height:18, borderRadius:'50%', display:'flex', alignItems:'center', justifyContent:'center' },
  ...
  heroTag: { fontSize:10, letterSpacing:'0.3em', color:'#b09060', textTransform:'uppercase', marginBottom:'1.5rem', display:'block', animation:'fadeUp .6s ease both' },
  ...
  heroSub: { fontSize:12, letterSpacing:'0.1em', color:'rgba(255,255,255,0.3)', marginBottom:'2.5rem', fontWeight:300, textTransform:'uppercase', animation:'fadeUp .7s ease .2s both' },
  heroBtns: { display:'flex', gap:12, animation:'fadeUp .7s ease .3s both', flexWrap:'wrap', justifyContent:'center' },
  heroScroll: { position:'absolute', bottom:32, left:'50%', transform:'translateX(-50%)', display:'flex', flexDirection:'column', alignItems:'center', gap:6, color:'rgba(255,255,255,0.3)', fontSize:9, letterSpacing:'0.2em', textTransform:'uppercase', animation:'fadeIn 1.2s ease 1s both' },

  // Buttons
  btnGold: { background:'#b09060', color:'#fff', border:'none', padding:'13px 28px', fontFamily:'var(--ff-sans)', fontSize:11, letterSpacing:'0.15em', textTransform:'uppercase', cursor:'pointer', borderRadius:2, transition:'background .15s' },
  btnOutline: { background:'transparent', color:'rgba(255,255,255,0.55)', border:'0.5px solid rgba(255,255,255,0.08)', padding:'13px 28px', fontFamily:'var(--ff-sans)', fontSize:11, letterSpacing:'0.15em', textTransform:'uppercase', cursor:'pointer', borderRadius:2, transition:'all .15s' },
  ...
  sLink: { fontSize:10, letterSpacing:'0.15em', textTransform:'uppercase', color:'#b09060', cursor:'pointer', background:'none', border:'none', fontFamily:'var(--ff-sans)' },
  ...
  featNotes: { fontSize:10, color:'rgba(255,255,255,0.3)', marginBottom:4 },
  ...
  cardNotes: { fontSize:9, color:'rgba(255,255,255,0.3)', marginBottom:10, lineHeight:1.4 },
  cardFooter: { display:'flex', alignItems:'center', justifyContent:'space-between' },
  pr: { fontSize:11, color:'rgba(255,255,255,0.92)' },
  ...
  searchInput: { flex:1, border:'none', outline:'none', fontFamily:'var(--ff-sans)', fontSize:13, color:'rgba(255,255,255,0.92)', background:'transparent' },
  tabs: { display:'flex', borderBottom:'0.5px solid rgba(255,255,255,0.08)', marginBottom:'1.25rem' },
  tab: { flex:1, padding:'0.85rem', textAlign:'center', fontSize:11, letterSpacing:'0.12em', textTransform:'uppercase', cursor:'pointer', color:'rgba(255,255,255,0.3)', background:'none', border:'none', borderBottom:'2px solid transparent', fontFamily:'var(--ff-sans)', transition:'all .15s' },
  tabActive: { color:'rgba(255,255,255,0.92)', borderBottom:'2px solid #b09060' },
  countLbl: { fontSize:11, color:'rgba(255,255,255,0.3)', marginBottom:'1rem' },
  ...
  cartEmpty: { padding:'3rem 0', textAlign:'center', color:'rgba(255,255,255,0.3)', fontSize:13, fontFamily:'var(--ff-serif)', fontStyle:'italic' },
  ...
  cartItemSize: { fontSize:10, color:'rgba(255,255,255,0.3)' },
  cartItemR: { display:'flex', flexDirection:'column', alignItems:'flex-end', gap:7, flexShrink:0 },
  cartItemPrice: { fontSize:13, color:'rgba(255,255,255,0.92)' },
  ...
  qtyVal: { fontSize:12, minWidth:16, textAlign:'center', color:'rgba(255,255,255,0.92)' },
  ...
  totalLbl: { fontSize:11, letterSpacing:'0.1em', textTransform:'uppercase', color:'rgba(255,255,255,0.3)' },
  ...
  cartNote: { fontSize:10, color:'rgba(255,255,255,0.3)', textAlign:'center', marginTop:10, lineHeight:1.5 },
  ...
  modalNotes: { fontSize:11, color:'rgba(255,255,255,0.3)', marginBottom:'1.25rem', fontStyle:'italic' },
  ...
  sizeSp: { fontSize:13, color:'rgba(255,255,255,0.3)' },
  ...
  btnCancel: { padding:'13px 18px', border:'0.5px solid rgba(255,255,255,0.08)', background:'transparent', cursor:'pointer', fontFamily:'var(--ff-sans)', fontSize:11, color:'rgba(255,255,255,0.3)', borderRadius:2 },
  ...
  promiseTitle: { fontSize:10, letterSpacing:'0.12em', textTransform:'uppercase', marginBottom:4, color:'rgba(255,255,255,0.92)' },
  promiseSub: { fontSize:10, color:'rgba(255,255,255,0.3)', lineHeight:1.5 },
  ...
  aP: { fontSize:13, color:'rgba(255,255,255,0.55)', lineHeight:1.95, marginBottom:'1.5rem' },
  ...
  howTitle: { fontSize:13, fontWeight:500, color:'rgba(255,255,255,0.92)', marginBottom:5, fontFamily:'var(--ff-sans)' },
  howText: { fontSize:13, color:'rgba(255,255,255,0.55)', lineHeight:1.8 },
  faqItem: { borderBottom:'0.5px solid rgba(255,255,255,0.08)', padding:'0.9rem 0' },
  faqQ: { fontSize:13, cursor:'pointer', display:'flex', justifyContent:'space-between', alignItems:'flex-start', gap:'1rem', color:'rgba(255,255,255,0.92)', background:'none', border:'none', width:'100%', textAlign:'left', fontFamily:'var(--ff-sans)' },
  faqToggle: { color:'#b09060', fontSize:18, flexShrink:0, width:20, height:20, display:'flex', alignItems:'center', justifyContent:'center' },
  faqA: { fontSize:12, color:'rgba(255,255,255,0.55)', lineHeight:1.8, paddingTop:10 },

  // Footer
  footer: { background:'#0c0a08', color:'rgba(255,255,255,0.3)', textAlign:'center', padding:'3rem 2rem', fontSize:11, letterSpacing:'0.07em', borderTop:'2px solid #b09060' },
  ...
  toast: { position:'fixed', bottom:90, left:'50%', transform:'translateX(-50%)', background:'#1e1a16', color:'rgba(255,255,255,0.92)', fontFamily:'var(--ff-sans)', fontSize:12, letterSpacing:'0.05em', padding:'10px 20px', borderRadius:2, zIndex:999, borderLeft:'2px solid #b09060', whiteSpace:'nowrap', animation:'fadeUp .3s ease', border:'0.5px solid rgba(255,255,255,0.08)' },
};
